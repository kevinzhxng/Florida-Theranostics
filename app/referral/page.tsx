    ...
    try {
      ...
      if (response.ok) {
        setSubmitStatus({
          type: "success",
          message:
            "Thank you. Your referral has been submitted. We will process it and contact you as needed.",
        });
        setForm({
          patientName: "",
          dob: "",
          ...
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-serif font-normal text-charcoal leading-tight">
                Referrals & Order Forms
              </h1>
              <p className="text-sm font-sans text-text-muted mt-1">
                For referring providers · FLT Molecular Imaging and Therapy Ordering Form (HIPAA-compliant)
              </p>
            </div>
            <div className="flex flex-wrap gap-4 text-sm font-sans text-text-muted shrink-0">
              <a href="tel:+15618473797" className="hover:text-charcoal transition-colors">
                (561) 847-3797
              </a>
              <a href="tel:+15616004476" className="hover:text-charcoal transition-colors">
                (561) 600-4476
              </a>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      autoComplete="tel"
                    />
                    <p className="text-xs text-text-muted mt-1">Primary contact · 10 digits, no formatting needed</p>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      name="cell"
                      value={form.cell}
                      onChange={handlePhoneChange("cell")}
                      className={inputClass}
                      placeholder="(555) 555-5555"
                      maxLength={14}
                      inputMode="numeric"
                      autoComplete="tel"
                    />
                    <p className="text-xs text-text-muted mt-1">Mobile (optional)</p>
                  </div>
                  <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      id="insuranceSecondary"
                      name="insuranceSecondary"
                      value={form.insuranceSecondary}
                      onChange={handleChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      type="text"
                      id="subscriberIdPrimary"
                      name="subscriberIdPrimary"
                      required
                      value={form.subscriberIdPrimary}
                      onChange={handleChange}
                      className={inputClass}
                    />
                  </div>
                  <div>
                    ...
                    <input
                      type="text"
                      id="subscriberIdSecondary"
                      name="subscriberIdSecondary"
                      value={form.subscriberIdSecondary}
                      onChange={handleChange}
                      className={inputClass}
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePhoneChange("physicianPhone")}
                      className={inputClass}
                      placeholder="(555) 555-5555"
                      maxLength={14}
                      inputMode="numeric"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="physicianFax"
                      name="physicianFax"
                      value={form.physicianFax}
                      onChange={handlePhoneChange("physicianFax")}
                      className={inputClass}
                      placeholder="(555) 555-5555"
                      maxLength={14}
                      inputMode="numeric"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="diagnosisReason" className={labelClass}>
                      Diagnosis and Reason for Order (complete details) *
                    </label>
                    <textarea
                      id="diagnosisReason"
                      ...
                      required
                      rows={4}
                      value={form.diagnosisReason}
                      onChange={handleChange}
                      className={`${inputClass} resize-none`}
                      placeholder="Provide complete clinical details"
                    />
                  </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {MOLECULAR_IMAGING_OPTIONS.map((opt) => (
                        <label key={opt.value} className="flex items-center gap-2 text-sm font-sans text-charcoal cursor-pointer">
                          <input
                            type="checkbox"
                            checked={form.molecularImaging.includes(opt.value)}
                            onChange={(e) =>
                              handleCheckbox("molecularImaging", opt.value, e.target.checked)
                            }
                            className="rounded border-charcoal/30 text-navy focus:ring-navy"
                          />
                          <span>{opt.label}</span>
                        </label>
                      ))}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {RADIOLIGAND_THERAPY_OPTIONS.map((opt) => (
                        <label key={opt.value} className="flex items-center gap-2 text-sm font-sans text-charcoal cursor-pointer">
                          <input
                            type="checkbox"
                            checked={form.radioligandTherapy.includes(opt.value)}
                            onChange={(e) =>
                              handleCheckbox("radioligandTherapy", opt.value, e.target.checked)
                            }
                            className="rounded border-charcoal/30 text-navy focus:ring-navy"
                          />
                          <span>{opt.label}</span>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={inputClass}
                      placeholder="Other imaging or therapy"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-sans text-text-muted mb-2">
                  Recent progress notes and imaging reports (max 5 files, 10 MB each)
                </p>
                <input
                  type="file"
                  id="attachments"
                  ...
                  className="block w-full text-sm font-sans text-charcoal file:mr-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:bg-navy file:text-warm-white file:font-medium file:cursor-pointer hover:file:bg-navy-light"
                />
              ...
              <button
                ...
                className="w-full md:w-auto px-8 py-3.5 text-sm font-sans font-medium tracking-wide transition-all duration-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-navy focus:ring-offset-2 focus:ring-offset-warm-white bg-navy text-warm-white hover:bg-navy-light disabled:opacity-50 disabled:cursor-not-allowed"
              >
